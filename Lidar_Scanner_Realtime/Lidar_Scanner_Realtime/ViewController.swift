...
class ViewController: UIViewController, ARSessionDelegate {
    ...
    @IBOutlet var btnSetFrameRate: UIButton!
    @IBOutlet var btnSaveObj: UIButton!
    ...
    override func viewDidLoad() {
        ...
        btnSetUDP.layer.cornerRadius = 10
        
        txtFrameRate.layer.cornerRadius = 10
        txtFrameRate.clipsToBounds = true
        btnSetFrameRate.layer.cornerRadius = 10
        
        btnTest.layer.cornerRadius = 10
        btnSaveObj.layer.cornerRadius = 10
        ...
        timer =  Timer.scheduledTimer(withTimeInterval: 1.0 / frameRate, repeats: true) { [self] (timer) in
            if realTime {
                ...
                // Making array but can't send it throw OSC because of the baud rate
...
//                oscSend(vertexString)
    ...
    @IBAction func btnSetUDP(_ sender: UIButton) {
